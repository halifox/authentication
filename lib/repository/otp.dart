...
class OTP {
  ...
  static String generateTOTPCodeString({
    ...
    return '${generateTOTPCode(secret: secret, unixMilliseconds: unixMilliseconds, digits: digits, intervalSeconds: intervalSeconds, algorithm: algorithm, isBase32: isBase32)}'
        .padLeft(digits, '0');
  }
  ...
  static String generateHOTPCodeString({
    ...
    return '${generateHOTPCode(secret: secret, counter: counter, digits: digits, algorithm: algorithm, isBase32: isBase32)}'
        .padLeft(digits, '0');
  }
  ...
  static String generateMOTPCodeString({
    ...
    return hashlib
        .md5sum('${((unixMilliseconds ~/ 1000).round()) ~/ intervalSeconds}$secret$pin', null, true)
        .substring(0, digits);
  }
  ...
  static String _hexEncode(final Uint8List input) =>
      <String>[for (int i = 0; i < input.length; i++) input[i].toRadixString(16).padLeft(2, '0')].join();
