...
const Color kCupertinoModalBarrierColor = CupertinoDynamicColor.withBrightness(color: Color(0x33000000), darkColor: Color(0x7A000000));
...
///  * [ReverseCupertinoPageRoute], which is a [PageRoute] that leverages this mixin.
mixin CupertinoRouteTransitionMixin<T> on PageRoute<T> {
  ...
  /// The title string of the previous [ReverseCupertinoPageRoute].
  ///
  ...
  /// is not a [ReverseCupertinoPageRoute].
  ///
  /// See also:
  ///
  ...
  ///
  /// Used by [ReverseCupertinoPageRoute.buildTransitions].
  ///
  /// This method can be applied to any [PageRoute], not just
  /// [ReverseCupertinoPageRoute]. It's typically used to provide a Cupertino style
  ...
  static Widget buildPageTransitions<T>(PageRoute<T> route, BuildContext context, Animation<double> animation, Animation<double> secondaryAnimation, Widget child) {
    ...
    if (route.fullscreenDialog) {
      return CupertinoFullscreenDialogTransition(primaryRouteAnimation: animation, secondaryRouteAnimation: secondaryAnimation, linearTransition: linearTransition, child: child);
    } else {
      return CupertinoPageTransition(
        primaryRouteAnimation: animation,
        secondaryRouteAnimation: secondaryAnimation,
        linearTransition: linearTransition,
        child: _CupertinoBackGestureDetector<T>(enabledCallback: () => route.popGestureEnabled, onStartPopGesture: () => _startPopGesture<T>(route), child: child),
      );
    }
  }
...
class ReverseCupertinoPageRoute<T> extends PageRoute<T> with CupertinoRouteTransitionMixin<T> {
  /// Creates a page route for use in an iOS designed app.
  ///
  /// The [builder], [maintainState], and [fullscreenDialog] arguments must not
  /// be null.
  ReverseCupertinoPageRoute({
...
class _PageBasedCupertinoPageRoute<T> extends PageRoute<T> with CupertinoRouteTransitionMixin<T> {
  ...
  @override
  DelegatedTransitionBuilder? get delegatedTransition => fullscreenDialog ? null : CupertinoPageTransition.delegatedTransition;
...
/// See also:
///
///  * [ReverseCupertinoPageRoute], for a [PageRoute] version of this class.
...
class CupertinoPageTransition extends StatefulWidget {
  ...
  ///
  const CupertinoPageTransition({super.key, required this.primaryRouteAnimation, required this.secondaryRouteAnimation, required this.child, required this.linearTransition});
  ...
  static Widget? delegatedTransition(BuildContext context, Animation<double> animation, Animation<double> secondaryAnimation, bool allowSnapshotting, Widget? child) {
    final CurvedAnimation animation = CurvedAnimation(parent: secondaryAnimation, curve: Curves.linearToEaseOut, reverseCurve: Curves.easeInToLinear);
    final Animation<Offset> delegatedPositionAnimation = animation.drive(_kMiddleLeftTween);
    animation.dispose();

    assert(debugCheckHasDirectionality(context));
    final TextDirection textDirection = Directionality.of(context);
    return SlideTransition(position: delegatedPositionAnimation, textDirection: textDirection, transformHitTests: false, child: child);
  }
...
class _CupertinoPageTransitionState extends State<CupertinoPageTransition> {
  ...
  void _setupAnimation() {
    if (!widget.linearTransition) {
      _primaryPositionCurve = CurvedAnimation(parent: widget.primaryRouteAnimation, curve: Curves.fastEaseInToSlowEaseOut, reverseCurve: Curves.fastEaseInToSlowEaseOut.flipped);
      _secondaryPositionCurve = CurvedAnimation(parent: widget.secondaryRouteAnimation, curve: Curves.linearToEaseOut, reverseCurve: Curves.easeInToLinear);
    ...
    _primaryShadowAnimation = (_primaryShadowCurve ?? widget.primaryRouteAnimation).drive(_CupertinoEdgeShadowDecoration.kTween);
  }
...
class CupertinoFullscreenDialogTransition extends StatefulWidget {
  ...
  ///
  const CupertinoFullscreenDialogTransition({super.key, required this.primaryRouteAnimation, required this.secondaryRouteAnimation, required this.child, required this.linearTransition});
...
class _CupertinoBackGestureDetector<T> extends StatefulWidget {
  const _CupertinoBackGestureDetector({super.key, required this.enabledCallback, required this.onStartPopGesture, required this.child});
...
///
/// This is created by a [ReverseCupertinoPageRoute] in response from a gesture caught
...
class _CupertinoBackGestureController<T> {
  ...
  _CupertinoBackGestureController({required this.navigator, required this.controller, required this.getIsActive, required this.getIsCurrent}) {
...
class _CupertinoEdgeShadowDecoration extends Decoration {
  ...
  //
  //  * [Decoration.lerp].
  static _CupertinoEdgeShadowDecoration? lerp(_CupertinoEdgeShadowDecoration? a, _CupertinoEdgeShadowDecoration? b, double t) {
    if (identical(a, b)) {
      return a;
    }
    if (a == null) {
    ...
    return _CupertinoEdgeShadowDecoration._(<Color>[for (int i = 0; i < b._colors!.length; i += 1) Color.lerp(a._colors?[i], b._colors[i], t)!]);
  }
...
const SpringDescription _kStandardSpring = SpringDescription(mass: 1, stiffness: _kStandardStiffness, damping: _kStandardDamping);
...
class CupertinoModalPopupRoute<T> extends PopupRoute<T> {
  ...
  Simulation createSimulation({required bool forward}) {
    ...
    return SpringSimulation(_kStandardSpring, controller!.value, end, 0, tolerance: _kStandardTolerance, snapToEnd: true);
  }
  ...
  static final Tween<Offset> _offsetTween = Tween<Offset>(begin: const Offset(0.0, 1.0), end: Offset.zero);
}
