...
class AuthDetailsPage extends StatelessWidget {
  AuthDetailsPage({super.key, AuthConfiguration? authConfiguration}) {
    rxConfiguration = Rx(authConfiguration ?? AuthConfiguration(account: "", secret: "", issuer: ""));
  }

  late Rx<AuthConfiguration> rxConfiguration;
